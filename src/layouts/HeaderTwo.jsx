...
//           </li>
//           {/* dropdown */}
//           <li className='border-b border-[#D9D9D936] pb-4'>
//             <div className='flex items-center justify-between text-xs-base text-white pt-6 pb-[15px]'>
//               <span className='text-transparent bg-clip-text bg-text-gradient' style={{ textShadow: '0px 4.77px 18.13px #9A2E1B' }}>Setting</span>
//               <svg
//                 width='8'
//                 height='13'
//                 viewBox='0 0 8 13'
...
//             <ul className=''>
//               <li>
//                 <Link className='flex items-center gap-[15px] py-[15px] px-5 '>
...
//                 <Link className='flex items-center gap-[15px] py-[15px] px-5 '>
//                   <div className='flex items-center w-[15px]'>
//                     <img src='/images/affiliates.svg' alt='' />
//                   </div>
//                   <span>Affiliates</span>
//                 </Link>
//               </li>
//               <li>
//                 <Link className='flex items-center gap-[15px] py-[15px] px-5 bg-[#181c26]'>
//                   <div className='flex items-center w-[15px]'>
...
//               </li>
//               <li>
//                 <Link className='flex items-center gap-[15px] py-[15px] px-5  text-[#FF4040]'>
//                   <div className='flex items-center w-[15px]'>
...
export default function HeaderTwo() {
  ...
  // Toggle currency dropdown visibility
  const handleToggleDropdown = () => {
    setIsDropdownOpen((prev) => !prev);
  };
  ...
  // Toggle Settings dropdown in mobile menu
    ...
    <header className='py-4'>
      ...
      >
        ...
        <ul className='py-8 px-[15px]'>
          ...
          <li className='border-b border-[#D9D9D936] pb-4'>
            <div
              className='flex items-center justify-between text-xs-base text-white pt-6 pb-[15px] cursor-pointer'
              onClick={handleToggleSettings}
            >
              <span
                className={`${
                  isSettingsOpen
                    ? 'text-[#FD9C00] [text-shadow:0px_4.77px_18.13px_#9A2E1B] text-transparent bg-clip-text bg-text-gradient'
                    : ''
                }`}
              >
                Settings
              ...
              >
                <path
                  ...
                  clipRule='evenodd'
                  d='M7.071 7.071L1.414 12.728L0 11.314L4.95 6.364L0 1.414L1.414 0L7.071 5.657C7.25847 5.84453 7.36379 6.09884 7.36379 6.364C7.36379 6.62916 7.25847 6.88347 7.071 7.071Z'
                  fill={isSettingsOpen ? '#FD9C00' : '#38383B'}
                />
              </svg>
            </div>
            {/* Dropdown Items */}
            <ul className={`${isSettingsOpen ? 'block' : 'hidden'}`}>
              <li>
                <Link
                  className={`flex items-center gap-[15px] py-[15px] px-5 ${
                    location.pathname === '/main/personal' ? 'bg-[#181c26]' : ''
                  }`}
                  to='/main/personal'
                >
                  <div className='flex items-center w-[15px]'>
                    <img src='/images/user.svg' alt='Personal Area icon' />
                  </div>
                  <span>Personal Area</span>
                </Link>
              </li>
              <li>
                ...
                >
                  <div className='flex items-center w-[15px]'>
                    <img src='/images/affiliates.svg' alt='Affiliates icon' />
                  </div>
                  <span>Affiliates</span>
                </Link>
              </li>
              <li>
                <Link
                  className={`flex items-center gap-[15px] py-[15px] px-5 ${
                    location.pathname === '/trade-skins' ? 'bg-[#181c26]' : ''
                  }`}
                  to='/trade-skins'
                >
                  <div className='flex items-center w-[15px]'>
              ...
              <li>
                <Link
                  className='flex items-center gap-[15px] py-[15px] px-5 text-[#FF4040]'
                  to='#!'
                >
                  <div className='flex items-center w-[15px]'>
                    <img src='/images/sign-out.svg' alt='Sign out icon' />
                  </div>
                  <span>Sign Out</span>
                </Link>
              </li>
