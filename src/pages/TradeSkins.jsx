...
const SkinCard = ({ imageSrc, title, price }) => (
  <div className='w-[123px] pt-5 pb-3 px-3 bg-skin-child-card relative hover:shadow-[6px_29px_60.9px_0px_#00000042] duration-300 group'>
...
const OfferSection = ({ title, total, skins }) => (
  <div className='flex-1'>
    ...
    <div className='rounded-[9px] overflow-hidden bg-[#212044]'>
      <div className='flex items-center justify-between py-[10px] px-[14px]'>
      ...
      <div className='py-5 px-[14px] grid grid-cols-4 bg-skin-card gap-[10px] custom-scroll overflow-y-auto max-h-[785px]'>
        ...
        <div className='bg-product-card-bg bg-[length:100%_100%] bg-no-repeat pb-[14px] h-fit px-3 relative'>
  ...
  return (
    <div>
      ...
      <div className='max-w-[1794px] mx-auto mt-[58px] mb-[95px] flex gap-5 items-stretch'>
        <OfferSection title='Your Offer' total='$5,585,555' skins={skins} />
        ...
        <div className='w-[272px] rounded-[9px] overflow-hidden'>
          ...
          <div className='p-[15px] pb-5 bg-skin-card space-y-6'>
            ...
            <button className='bg-[#292840] rounded-[9px] p-[18px] w-full'>
              Reset filter
            </button>
          </div>
        </div>
